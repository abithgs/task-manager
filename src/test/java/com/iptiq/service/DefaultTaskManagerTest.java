...
class DefaultTaskManagerTest {
    ...
    void shouldAddNewProcessToStore() throws TaskManagerFullException {
        DefaultTaskManager taskManager = new DefaultTaskManager(10);
    ...
    @Test
    void shouldThrowExceptionOnStoreFull() throws TaskManagerFullException {
        DefaultTaskManager taskManager = new DefaultTaskManager(1);

        Process process = taskManager.add(Process.Priority.HIGH);

        assertThrows(TaskManagerFullException.class, () -> taskManager.add(Process.Priority.LOW));
        assertThat(taskManager.list()).hasSize(1).contains(process);
    }

    @Test
    void shouldKillProcessWithPid() throws TaskManagerFullException {
        DefaultTaskManager taskManager = new DefaultTaskManager(10);
    ...
    @Test
    void shouldKillAllProcesses() throws TaskManagerFullException {
        DefaultTaskManager taskManager = new DefaultTaskManager(10);
    ...
    @Test
    void shouldKillProcessGroup() throws TaskManagerFullException {
        DefaultTaskManager taskManager = new DefaultTaskManager(10);
